    ...
    return (
        <>
            {content ? (
                <>
                    <span
                        className=" shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm hover:bg-[#fafafa]"
                        onClick={(e) => {
                            e.stopPropagation();
                        ...
                        <a className="cursor-pointer hover:group/item ">
                            ...
                            <h3 className="font-medium my-4 line-clamp-2 px-4" title={content.name}>{content.name}</h3>
                            <div className="text-sm mb-2 font-light px-4">{content.created_user_info[content.created_by]}</div>
                            ...
                            <div className="flex gap-1.5 items-center mb-2 px-4">
