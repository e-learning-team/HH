...
export function RatingBar({ value, totalReview, className }) {
    ...
    return (
        <div className={`${className} flex items-center gap-2 text-sm`}>
            ...
            <Rating name="half-rating-read" className=" text-sm " value={Number(value)} precision={0.5}  readOnly emptyIcon={<StarIcon className="" style={{ stroke: `#faaf00`, opacity: 0.55 }} fontSize="inherit" />} />
